    ...
    <div className="w-full text-black text-[1.2rem] px-10 py-4 md:max-w-[800px] md:mx-auto">
      <div className="grid grid-cols-3">
        <div className="relative row-span-2 h-[200px]">
          <Image className="transition object-cover object-top ease-in-out transform hover:object-center duration-500" src="/assets/images/cat.jpg" alt="tree-image" fill sizes="100vw" />
        </div>
