...
const Header = () => {
  ...
  return (
    <header className="flex  justify-center md:items-center bg-black md:h-[100px] md:w-full">
      <div className=" h-[100px] w-full px-10 flex justify-between items-center md:hidden">
        ...
        <div
          className="text-[40px] z-[1000] text-[#433ec4]"
      ...
      >
        <li className="" onClick={handleNav}>
          <Link
            href="/"
            className="relative text-[#a09eff] no-underline text-3xl font-black uppercase  md:inline-block  md:text-base md:font-normal  md:mx-2.5 md:my-0 md:pb-[5px]"
          >
            Home{" "}
            <span className="absolute bg-[#007efc] w-[0%] h-0.5 transition-all duration-[0.6s] left-0 bottom-0 hover:w-full"></span>
          </Link>
        </li>
        <li className="" onClick={handleNav}>
          <Link
